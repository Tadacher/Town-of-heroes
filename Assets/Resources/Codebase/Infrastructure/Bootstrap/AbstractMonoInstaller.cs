...
namespace Infrastructure
{
    public abstract class AbstractMonoInstaller : MonoInstaller
    {
        ...
        protected ConcreteIdArgConditionCopyNonLazyBinder InstallInterfaceBindingFromInstance<TInterface, TRealization>(TRealization instance) where TRealization : TInterface
        ...
        protected ConcreteIdArgConditionCopyNonLazyBinder BindScriptableObject<TDependency>(TDependency instance) where TDependency : ScriptableObject
            => Container.Bind<TDependency>().FromInstance(instance).AsSingle();
        protected ConcreteIdArgConditionCopyNonLazyBinder BindInterfacesAndSelft<TService>() where TService : class => 
